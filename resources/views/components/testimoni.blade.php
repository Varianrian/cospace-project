<h5 class="pl-12 ml-12 mt-12 mb-2 text-xl text-left font-bold text-black md:text-xl lg:text-xl dark:text-green">Testimoni</h5>
    <p class="pl-12 ml-12 mb-6 text-sm text-left font-light text-gray-500 lg:text-sm dark:text-gray-400">Pendapat Mereka tentang CoSpace</p>
<div class="grid grid-cols-3 gap-8 mx-24">
    <div class="testi p-5 pb-1 max-w-sm bg-indigo-200 border border-gray-200 rounded-lg">
        ...
        <div class="py-5 px-2">
            ...
            <p class="mt-2 ms-1 text-xs  text-black">Lorem ipsum dolor sit amet, consectetur dipiscing elit eiusmod  dipiscing elit eiusmod </p>
        </div>
    </div>
