<div class="pt-12 px-4 lg:px-24">
  ...
  <div class="flex flex-col items-center sm:flex-row sm:justify-center lg:gap-8 gap-y-4">
    <x-testimoni-card
      name="Olivia"
      job="Freelancer"
    ...
    <div class="rounded-[5px] border-[1px] border-[#211951] bg-white p-7">
      <h5 class="font-medium text-black xl:text-[20px] lg:text-[16px]">Alaina</h5>
      <p class="text-left font-light text-[#666666] xl:text-[16px] lg:text-[12px]">Worker</p>
        ...
        <p class="mt-3 text-[14px] text-black">
          Pelayanan pemesanan CoSpace
          sangat baik. Saya mendapat ruang
          sesuai kebutuhan tanpa repot
        </p>
    </div>
    <x-testimoni-card
      name="Conan"
