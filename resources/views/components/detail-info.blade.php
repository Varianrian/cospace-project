<div>
  ...
  <div class="grid xl:grid-cols-2 lg:xl:grid-cols-2 gap-2 xl:pl-32 py-7">
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <img src="assets/images/eduplex3.png" alt="" />
      <img src="assets/images/eduplex4.png" alt="" />
  ...
  <div class="flex justify-between px-28">
    <div class="">
      ...
      <div class="flex items-center">
        ...
        <p class="ml-1 text-[16px] leading-8">Jl. Ir. H. Juanda No.84, Lebakgede</p>
      </div>
      <div class="flex">
        @for ($i = 0; $i < 4; $i++)
          <svg
    ...
    <div>
      <p class="flex justify-end text-[20px] font-semibold">
        Mulai dari
        <span class="text-[#079D75]">15.000</span>
        /Jam
      </p>
  ...
  <div class="flex flex-row justify-between gap-[85px] px-28 py-6">
    <div class="basis-3/5">
      ...
      <div class="text-justify">
        <p class="mt-2 text-[16px] font-normal leading-6 text-[#112211]">
          Terletak di pusat kota Bandung, kami menyediakan opsi terbaik dan akses mudah untuk ruang kerja. Kami memiliki
          area co-working, ruang rapat, dan juga kantor pribadi yang dapat Anda pilih untuk mendukung aktivitas kerja
          Anda. Kami mengutamakan kenyamanan setiap anggota saat bekerja di area co-working kami. Area kerja bersama
          kami dirancang sebagai ruang yang tenang untuk mendukung kenyamanan anggota kami selama mereka tinggal di
          sana.
        </p>
      </div>
      <div class="mt-5 flex gap-4">
        <div class="rounded-[5px] bg-[#A7FBE5] py-3 pl-4 pr-12">
          <p class="text-[32px] font-medium text-[#112211]">4.2</p>
          <p class="text-[14px] font-medium leading-7">Sangat Bagus</p>
          <p class="text-[12px]">20 Ulasan</p>
        </div>
        <div class="flex flex-col justify-between rounded-[5px] border border-[#079D75] pb-3 pl-4 pr-12">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="50"
            height="50"
          ...
          <p class="mt-4 text-[16px]">WiFi Gratis</p>
        </div>
        <div class="flex flex-col justify-between rounded-[5px] border border-[#079D75] py-4 pl-4 pr-12">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
            height="30"
          ...
          <p class="mt-4 text-[16px]">Parkir Gratis</p>
        </div>
        <div class="flex flex-col justify-between rounded-[5px] border border-[#079D75] py-4 pl-4 pr-12">
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="grid basis-2/5 justify-end">
      ...
      <img class="lg:h-[225px] lg:w-[495px]" src="assets/images/map.png" alt="" />
      ...
      <div class="flex items-center">
        ...
        <a href="#" class="text-[16px] underline">Jl. Ir. H. Juanda No.84, Lebakgede</a>
      </div>
    </div>
  </div>
</div>
