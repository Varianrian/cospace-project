  ...
  <div class="mt-8 w-full rounded-md px-12 max-md:max-w-full max-md:px-5">
    <div class="flex gap-5 max-md:flex-col max-md:gap-0">
      <article class="flex w-6/12 flex-col max-md:ml-0 max-md:w-full">
        <section class="flex w-full flex-col justify-center rounded-md bg-indigo-200 max-md:mt-10 max-md:max-w-full">
            ...
            <div class="flex gap-5 max-md:flex-col max-md:gap-0">
              <div class="flex w-[77%] flex-col max-md:ml-0 max-md:w-full">
                ...
                >
                  <div class="flex items-center gap-1">
                    ...
                    />
                    <div class="my-auto h-1.5 flex-1 shrink-0 self-stretch rounded-sm bg-blue-800"></div>
                  </div>
                  <div class="mt-2 flex items-center gap-1 pr-4">
                    ...
                    <img
                      ...
                      class="my-auto aspect-square w-4 shrink-0 self-stretch fill-yellow-500"
                    />
                    <div class="my-auto h-1.5 w-[280px] max-w-full shrink-0 self-stretch rounded-sm bg-blue-800"></div>
                  </div>
                  <div class="mt-2 flex items-center gap-1 pr-20 max-md:pr-5">
                    ...
                    <img
                      ...
                      class="my-auto aspect-square w-4 shrink-0 self-stretch fill-yellow-500"
                    />
                    <div class="my-auto h-1.5 w-[60px] shrink-0 self-stretch rounded-sm bg-blue-800"></div>
                  </div>
                  <div class="mt-2 flex items-center gap-1 pr-20 max-md:pr-5">
                    ...
                    <img
                      ...
                      class="my-auto aspect-square w-4 shrink-0 self-stretch fill-yellow-500"
                    />
                    <div class="my-auto h-1.5 w-[19px] shrink-0 self-stretch rounded-sm bg-blue-800"></div>
                  </div>
              ...
              <div class="ml-5 flex w-[23%] flex-col max-md:ml-0 max-md:w-full">
                <div class="flex flex-col justify-center max-md:mt-10">
                  <div class="text-center text-[40px] font-bold tracking-tight text-black">4.5</div>
                  ...
                  <div class="mt-2 text-center text-[14px] font-medium tracking-normal text-black">20 Ulasan</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="ml-5 flex w-6/12 flex-col max-md:ml-0 max-md:w-full">
        <div class="flex grow flex-col text-zinc-800 max-md:mt-10 max-md:max-w-full">
              ...
              <div class="flex flex-1 justify-center gap-2">
                ...
                <div class="flex flex-1 flex-col">
                  ...
                  <div class="flex items-center">
                    ...
                    <span class="ml-2 text-[14px]">2 mins ago</span>
                  </div>
                </div>
              </div>
            </div>
            <p class="mt-2.5 text-[13px] leading-5 max-md:max-w-full">
              Consequat velit qui adipisicing sunt do rependerit ad laborum tempor ullamco exercitation. Ullamco tempor
          ...
          <article
            class="mt-5 flex flex-col justify-end rounded-md border border-solid border-indigo-200 bg-white p-2.5 max-md:max-w-full"
          >
            <div class="flex justify-center gap-4 max-md:flex-wrap">
              <div class="flex flex-1 justify-center gap-2">
                <img
          ...
          <div class="mt-5 h-px shrink-0 border border-solid border-zinc-500 max-md:max-w-full"></div>
          <article class="mt-5 flex flex-col justify-end rounded-md bg-indigo-200 p-2.5 max-md:max-w-full">
            <div class="flex justify-center gap-4 max-md:flex-wrap">
              <div class="flex flex-1 justify-center gap-2">
                <img
                  loading="lazy"
